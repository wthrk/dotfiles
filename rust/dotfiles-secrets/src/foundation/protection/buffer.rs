...
//!
//! `zeroize` 1.8.2 と `region` 3.0.2 の allocation / lock API の出典、memory lock の
//! best-effort policy は
...
impl ProtectedInputBuffer {
    ...
    ///
    /// allocation 全体を zeroize 管理へ入れ、利用可能な場合だけ memory lock guard を保持する。
