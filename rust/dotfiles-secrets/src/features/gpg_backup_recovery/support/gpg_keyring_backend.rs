...
use crate::{
    Result,
    features::gpg_backup_recovery::support::gpg_backup as backup_protection,
    features::{
        gpg_backup_recovery::{
            domain::{
                ...
                gpg_restore::{
                    ...
                    ResolvedSubkey, SubkeyCapability,
                },
            },
            support::{
                gpg_host_security,
                gpg_keyring::{
                    is_primary_subkey, required_gpgme_text, select_authentication_subkey,
                },
            },
        },
...
pub(crate) fn parse_backup_primary_fingerprint(
    ...
    backup_protection::inspect_backup(backup)
}
