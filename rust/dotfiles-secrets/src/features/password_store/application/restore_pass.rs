...
use crate::{
    ...
    features::{
        ...
        password_store::{
            domain::pass_restore::{PASSWORD_STORE_DIR_NAME, RestorePassSummary},
            ports::{GitClonePort, PasswordStorePort},
        },
...
) -> Result<crate::foundation::protection::ProtectedSecret> {
...
mod tests {
    ...
    mod ports {
        ...
        pub(crate) use crate::features::gpg_backup_recovery::ports::public::MockGpgKeyringPort;
        pub(crate) use crate::features::password_store::ports::public::{
            MockGitClonePort, MockPasswordStorePort,
        };
    }
