...
use crate::{
    Result,
    features::password_store::domain::commands::ProvisionPasswordStoreRemoteCommand,
    features::{
        bws_secrets::ports::public::{BwsClientPort, BwsProjectName, BwsSecretName},
        cli_interaction::ports::public::{
            BackupUpdateConfirmationPort, PasswordStoreRemoteInputPort,
        },
        password_store::domain::pass_restore::PasswordStoreRemote,
        yubikey_lifecycle::ports::public::{
            DeviceSerialPort, SecretName, SecretStoragePort, SecretStorageReadIntent,
        },
    },
...
where
    ...
    U: PasswordStoreRemoteInputPort + ?Sized,
    F: BackupUpdateConfirmationPort + ?Sized,
{
...
mod tests {
    ...
    mod ports {
        ...
        pub(crate) use crate::features::cli_interaction::ports::public::{
            MockBackupUpdateConfirmationPort, MockPasswordStoreRemoteInputPort,
        };
    }
    ...
    fn project_candidate() -> Vec<domain::bws::BwsLookupCandidate<domain::bws::BwsProjectId>> {
        vec![domain::bws::BwsLookupCandidate {
    ...
    async fn provision_updates_with_guard_after_confirmation() -> crate::Result<()> {
        ...
        bws.expect_list_bws_secrets().returning(|_, _| {
            Ok(vec![domain::bws::BwsLookupCandidate {
                id: domain::bws::BwsSecretId::new("pass-id"),
