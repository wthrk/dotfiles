...
#[derive(Default)]
pub(crate) struct GpgKeyringAdapter(GpgKeyringInner);
...
#[derive(Default)]
pub(crate) struct BackupCipherAdapter(BackupCipherInner);
...
#[derive(Default)]
pub(crate) struct SshAgentAdapter(SshAgentInner);
