...
- When delegating implementation work, the subagent prompt must instruct the subagent to read `.claude/skills/implementation-execution/SKILL.md` as its first action. Pass the work-item path and target code paths as parameters. Do not inline the skill's rules into the prompt.
- When delegating review work, the subagent prompt must instruct the subagent to read `.claude/skills/implementation-review-judgement/SKILL.md` as its first action. Pass the work-item path and review target as parameters. Do not inline the skill's rules into the prompt.
