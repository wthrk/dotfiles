...
4. main orchestrator が PR URL または PR 番号、PR review 対応、PR 文脈の AI/Codex/Copilot review、PR 文脈の `@codex review`、review thread resolve、PR 文脈の checks 確認、mergeability 確認を扱う場合は `docs/task-governance/pr-mergeability-loop.md`
...
- top-level の PR 指示に PR URL または PR 番号、PR review 対応、PR 文脈の AI/Codex/Copilot review、PR 文脈の `@codex review`、review thread resolve、PR 文脈の checks 確認、mergeability 確認が含まれる場合、main orchestrator は `/pr-mergeability-loop` もオーケストレーション拡張として使う。
