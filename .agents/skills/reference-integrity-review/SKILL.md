...
description: Use this skill when acting as the reference-integrity reviewer for document remediation.
---
...
While this skill is active, the current actor is the **reference-integrity reviewer**.
