...
- 規約違反の解消対象:
  ...
  - 追跡責務の不整合によるレビュー循環
- 同一変更セットで扱う文書カテゴリ:
  - governing sources: `docs/task-governance/*`, `docs/tasks/repo-governance/*`
  - included documentation targets: `AGENTS*`, `docs/docs-governance.md`, `docs/tasks/README.md`, `docs/task-governance/*`, `docs/task-governance/review-artifacts/*`, `docs/secret-recovery/implementation-guidelines.md`, secret-recovery 配下の移管支援/移管証跡文書
