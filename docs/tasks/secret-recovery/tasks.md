...
- 対象コードパス:
  ...
  - `rust/dotfiles-cli/tests/secrets_cli.rs`
- 次回着手前オーケストレーション記録:
  - 実装担当: `impl-agent-final-doc-dryrun`
  - 実装担当 agent/run 識別子: `agent:impl-final-doc-dryrun / run:2026-05-21-finaldoc-impl-001`
  - レビュー担当一覧:
    - 構造レビュー担当: `reviewer-structure-finaldoc-dryrun`
    - 構造レビュー担当 agent/run 識別子: `agent:review-structure-finaldoc / run:2026-05-21-finaldoc-rs-001`
    - 運用整合レビュー担当: `reviewer-ops-finaldoc-dryrun`
    - 運用整合レビュー担当 agent/run 識別子: `agent:review-ops-finaldoc / run:2026-05-21-finaldoc-ro-001`
    - セキュリティレビュー担当: `reviewer-security-finaldoc-dryrun`
    - セキュリティレビュー担当 agent/run 識別子: `agent:review-security-finaldoc / run:2026-05-21-finaldoc-rsec-001`
    - 仕様適合レビュー担当: `reviewer-spec-finaldoc-dryrun`
    - 仕様適合レビュー担当 agent/run 識別子: `agent:review-spec-finaldoc / run:2026-05-21-finaldoc-rsp-001`
    - 参照整合レビュー担当: `reviewer-reference-finaldoc-dryrun`
    - 参照整合レビュー担当 agent/run 識別子: `agent:review-reference-finaldoc / run:2026-05-21-finaldoc-rr-001`
  - 進捗判定担当: `progress-judge-finaldoc-dryrun`
  - 進捗判定担当 agent/run 識別子: `agent:progress-finaldoc / run:2026-05-21-finaldoc-pj-001`
  - 着手順序: `規約計画 -> 実装計画 -> 規約文書更新 -> 確認 -> レビュー -> 必要時の後続対応`
  - 役割別フォールバック記録（6項目必須）:
    - 対象役割: `セキュリティレビュー担当`
  ...
  - 現行対象再読確認: `2026-05-21: 対象文書パス配下と証跡テンプレートを再読済み`
  - 境界注記: `dry-run のため文書整合記録のみ。状態遷移は変更しない`
- 実装状態: `未実装`
- 固定実装単位トラッカー:
...
- 状態: `未開始`
- 主成果物: `文書差分`
- 作業定義文書: [work-items/final-documentation.md](work-items/final-documentation.md#18-最終ドキュメント整理)
- 粗粒度進捗: [issue-11-progress.md](issue-11-progress.md#11-系粗粒度進捗)
- 対象文書パス:
  - `docs/secret-recovery/README.md`
  - `docs/secret-recovery/implementation-guidelines.md`
  - `docs/tasks/secret-recovery/tasks.md`
  - `docs/tasks/secret-recovery/work-items/`
  - `docs/tasks/secret-recovery/review-artifacts/`
  - `docs/tasks/secret-recovery/issue-11-progress.md`
- 次回着手前オーケストレーション記録:
  - 実装担当: `未確定`
  - 実装担当 agent/run 識別子: `未確定`
  - レビュー担当一覧:
...
| 実装単位 | 状態 | 成果物 | 参照 |
| --- | --- | --- | --- |
| 規約計画 | 未着手 | `work-items/final-documentation.md` | [implementation-guidelines.md#規約計画](../../secret-recovery/implementation-guidelines.md#規約計画) |
| 実装計画 | 未着手 | `work-items/final-documentation.md` | [implementation-guidelines.md#実装計画](../../secret-recovery/implementation-guidelines.md#実装計画) |
| 規約文書更新 | 未着手 | `docs/tasks/secret-recovery/tasks.md` | [implementation-guidelines.md#規約文書更新](../../secret-recovery/implementation-guidelines.md#規約文書更新) |
| 確認 | 未着手 | `review-artifacts/final-documentation/confirmation.md` | [implementation-guidelines.md#確認](../../secret-recovery/implementation-guidelines.md#確認) |
| レビュー | 未着手 | `review-artifacts/final-documentation/review.md` | [implementation-guidelines.md#レビュー](../../secret-recovery/implementation-guidelines.md#レビュー) |
| 必要時の後続対応 | 未着手 | `review-artifacts/final-documentation/review.md` | [implementation-guidelines.md#必要時の後続対応](../../secret-recovery/implementation-guidelines.md#必要時の後続対応) |
