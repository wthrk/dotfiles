# managed zsh profile 用に生成した Powerlevel10k prompt layout。
#
# prompt 表示を変えるときだけ意図的に再生成する。
# ここを汎用 shell logic として扱わない。
# Generated by Powerlevel10k configuration wizard on 2026-03-08 at 08:16 JST.
...
() {
  ...
  ##################################[ dir: current directory ]##################################
  # Current directory colors. Use a darker blue for better contrast with white text.
